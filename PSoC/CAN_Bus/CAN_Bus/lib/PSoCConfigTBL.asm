...
export LoadConfigTBL_can_bus_Bank1
export LoadConfigTBL_can_bus_Bank0
export LoadConfigTBL_can_bus_Ordered
AREA lit(rom, rel)
LoadConfigTBL_can_bus_Bank0:
...
;  Instance name TX8SW, User Module TX8SW
;  Instance name Timer16, User Module Timer16
;       Instance name Timer16, Block Name TIMER16_LSB(DBB00)
	db		23h, 00h		;Timer16_CONTROL_LSB_REG(DBB00CR0)
	db		21h, ffh		;Timer16_PERIOD_LSB_REG(DBB00DR1)
	db		22h, 00h		;Timer16_COMPARE_LSB_REG(DBB00DR2)
;       Instance name Timer16, Block Name TIMER16_MSB(DBB01)
	db		27h, 04h		;Timer16_CONTROL_MSB_REG(DBB01CR0)
	db		25h, ffh		;Timer16_PERIOD_MSB_REG(DBB01DR1)
	db		26h, 00h		;Timer16_COMPARE_MSB_REG(DBB01DR2)
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_can_bus_Bank1:
;  Instance name SPIM, User Module SPIM
;       Instance name SPIM, Block Name SPIM(DCB02)
	db		28h, 06h		;SPIM_FUNCTION_REG (DCB02FN)
	db		29h, c6h		;SPIM_INPUT_REG    (DCB02IN)
	db		2ah, 6ch		;SPIM_OUTPUT_REG   (DCB02OU)
;  Instance name TX8SW, User Module TX8SW
;  Instance name Timer16, User Module Timer16
;       Instance name Timer16, Block Name TIMER16_LSB(DBB00)
	db		20h, 00h		;Timer16_FUNC_LSB_REG(DBB00FN)
	db		21h, 17h		;Timer16_INPUT_LSB_REG(DBB00IN)
	db		22h, 40h		;Timer16_OUTPUT_LSB_REG(DBB00OU)
;       Instance name Timer16, Block Name TIMER16_MSB(DBB01)
	db		24h, 20h		;Timer16_FUNC_MSB_REG(DBB01FN)
	db		25h, 37h		;Timer16_INPUT_MSB_REG(DBB01IN)
	db		26h, 40h		;Timer16_OUTPUT_MSB_REG(DBB01OU)
...
LoadConfigTBL_can_bus_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 02h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	...
	M8C_SetBank0
	mov	reg[07h], fch		; Port_1_DriveMode_2 register (PRT1DM2)
