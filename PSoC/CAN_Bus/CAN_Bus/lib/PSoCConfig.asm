...
export LoadConfig_can_bus
export _LoadConfig_can_bus
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_0_Data_SHADE], 2h

	lcall	LoadConfig_can_bus
	lcall	LoadConfigTBL_can_bus_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration can_bus
;
;    Load configuration registers for can_bus.
...
_LoadConfig_can_bus:
 LoadConfig_can_bus:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_can_bus_Bank0
    mov     X, <LoadConfigTBL_can_bus_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_can_bus_Bank1
    mov     X, <LoadConfigTBL_can_bus_Bank1
