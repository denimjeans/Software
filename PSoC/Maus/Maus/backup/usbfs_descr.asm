...
;;   Version: 1.90, Updated on 2012/3/2 at 9:15:35
...
USBFS_D0_C1_I0_IN_RPTS:                          
  ...
  TD_ENTRY       USB_DS_RAM, USBFS_HID_RPT_1_IN_RPT_SIZE, USBFS_INTERFACE_0_IN_RPT_DATA, NULL_PTR
.ENDLITERAL
...
USBFS_D0_C1_I0_OUT_RPTS:                         
  TD_START_TABLE 1                               ; Only 1 Transfer Descriptor
  TD_ENTRY       USB_DS_RAM, USBFS_HID_RPT_1_OUT_RPT_SIZE, USBFS_INTERFACE_0_OUT_RPT_DATA, NULL_PTR
.ENDLITERAL
ENDIF ; WIZARD_DEFINED_REPORT_STORAGE
;----------------------------------------------------------------------
...
USBFS_D0_C1_I0_FEATURE_RPTS:                     
  TD_START_TABLE 1                               ; Only 1 Transfer Descriptor
  TD_ENTRY       USB_DS_RAM, USBFS_HID_RPT_1_FEATURE_RPT_SIZE, USBFS_INTERFACE_0_FEATURE_RPT_DATA, NULL_PTR
.ENDLITERAL
ENDIF ; WIZARD_DEFINED_REPORT_STORAGE
;----------------------------------------------------------------------
