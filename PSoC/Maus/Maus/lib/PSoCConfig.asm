...
export LoadConfig_Maus
export _LoadConfig_Maus
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Maus
	lcall	LoadConfigTBL_Maus_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Maus
;
;    Load configuration registers for Maus.
...
_LoadConfig_Maus:
 LoadConfig_Maus:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Maus_Bank0
    mov     X, <LoadConfigTBL_Maus_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Maus_Bank1
    mov     X, <LoadConfigTBL_Maus_Bank1
