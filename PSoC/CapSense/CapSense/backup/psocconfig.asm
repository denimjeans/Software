...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_CapSense
	lcall	LoadConfigTBL_CapSense_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration CapSense
;
;    Load configuration registers for CapSense.
...
_LoadConfig_CapSense:
 LoadConfig_CapSense:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_CapSense_Bank0
    mov     X, <LoadConfigTBL_CapSense_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_CapSense_Bank1
    mov     X, <LoadConfigTBL_CapSense_Bank1
