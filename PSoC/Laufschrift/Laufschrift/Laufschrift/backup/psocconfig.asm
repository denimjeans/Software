...
export LoadConfig_Laufschrift
export _LoadConfig_Laufschrift
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_Laufschrift
	lcall	LoadConfigTBL_Laufschrift_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Laufschrift
;
;    Load configuration registers for Laufschrift.
...
;               CUR_PP
;
_LoadConfig_Laufschrift:
 LoadConfig_Laufschrift:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Laufschrift_Bank0
    mov     X, <LoadConfigTBL_Laufschrift_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Laufschrift_Bank1
    mov     X, <LoadConfigTBL_Laufschrift_Bank1
