...
;  Global Symbols
;-----------------------------------------------
export  Timer16_EnableInt
export _Timer16_EnableInt
export  Timer16_DisableInt
export _Timer16_DisableInt
export  Timer16_Start
export _Timer16_Start
export  Timer16_Stop
export _Timer16_Stop
export  Timer16_WritePeriod
export _Timer16_WritePeriod
export  Timer16_WriteCompareValue
export _Timer16_WriteCompareValue
export  Timer16_wReadCompareValue
export _Timer16_wReadCompareValue
export  Timer16_wReadTimer
export _Timer16_wReadTimer
export  Timer16_wReadTimerSaveCV
export _Timer16_wReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  wTimer16_ReadCompareValue  ; deprecated
export _wTimer16_ReadCompareValue  ; deprecated
export  wTimer16_ReadTimer         ; deprecated
export _wTimer16_ReadTimer         ; deprecated
export  wTimer16_ReadTimerSaveCV   ; deprecated
export _wTimer16_ReadTimerSaveCV   ; deprecated

export  wTimer16_ReadCounter       ; obsolete
export _wTimer16_ReadCounter       ; obsolete
export  wTimer16_CaptureCounter    ; obsolete
export _wTimer16_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_DisableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_WritePeriod
;
;  DESCRIPTION:
...
;
 Timer16_WritePeriod:
_Timer16_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer16_PERIOD_LSB_REG], A
   mov   A, X
   mov   reg[Timer16_PERIOD_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
_Timer16_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer16_COMPARE_LSB_REG], A
   mov   A, X
   mov   reg[Timer16_COMPARE_MSB_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_wReadCompareValue
;
;  DESCRIPTION:
...
_Timer16_wReadCompareValue:
 wTimer16_ReadCompareValue:                      ; this name deprecated
_wTimer16_ReadCompareValue:                      ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer16_COMPARE_MSB_REG]
   mov   X, A
   mov   A, reg[Timer16_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_wReadTimerSaveCV
;
;  DESCRIPTION:
...
_Timer16_wReadTimerSaveCV:
 wTimer16_ReadTimerSaveCV:                       ; this name deprecated
_wTimer16_ReadTimerSaveCV:                       ; this name deprecated
 wTimer16_ReadCounter:                           ; this name deprecated
_wTimer16_ReadCounter:                           ; this name deprecated
...
wCount_LSB:    equ   2
   ...
   mov   A, reg[Timer16_CONTROL_LSB_REG]         ; save the Control register
   push  A
   mov   A, reg[Timer16_COMPARE_LSB_REG]         ; save the Compare register
   push  A
   mov   A, reg[Timer16_COMPARE_MSB_REG]
   push  A
   mov   A, reg[Timer16_COUNTER_LSB_REG]         ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer16_COMPARE_MSB_REG]         ; Now grab DR2 (DR0) and save
   mov   [X+wCount_MSB], A
   mov   A, reg[Timer16_COMPARE_LSB_REG]
   mov   [X+wCount_LSB], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer16_wReadTimer
;
;  DESCRIPTION:
...
;
 Timer16_wReadTimer:
_Timer16_wReadTimer:
 wTimer16_ReadTimer:                             ; this name deprecated
_wTimer16_ReadTimer:                             ; this name deprecated
 wTimer16_CaptureCounter:                        ; this name deprecated
_wTimer16_CaptureCounter:                        ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer16_COUNTER_LSB_REG]         ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!

   mov   A, reg[Timer16_COMPARE_MSB_REG]         ; Return DR2 (actually DR0)
   mov   X, A
   mov   A, reg[Timer16_COMPARE_LSB_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
