...
export  DAC9_Start
export _DAC9_Start
export  DAC9_SetPower
export _DAC9_SetPower

export  DAC9_WriteBlind
export _DAC9_WriteBlind
export  DAC9_WriteBlind2B
export _DAC9_WriteBlind2B

export  DAC9_WriteStall
export _DAC9_WriteStall
export  DAC9_WriteStall2B
export _DAC9_WriteStall2B
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC9_Start
;  FUNCTION NAME: DAC9_SetPower
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC9_WriteBlind
;  FUNCTION NAME: DAC9_WriteBlind2B
;
;  DESCRIPTION:
...
_DAC9_WriteBlind:
  ...
  IF DAC9_OFFSETBINARY | DAC9_TWOSCOMPLEMENT
    swap  A, X                  ;  A <- upper, X <- lower
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC9_WriteStall
;  FUNCTION NAME: DAC9_WriteStall2B
;
;  DESCRIPTION:
...
_DAC9_Stop:
    ...
    and  reg[DAC9_MSB_CR3], ~bPWRMASK
    and  reg[DAC9_LSB_CR3], ~bPWRMASK
    RAM_EPILOGUE RAM_USE_CLASS_1 
    ret
.ENDSECTION

; End of File DAC9.asm
