...
export LoadConfig_evalboard
export _LoadConfig_evalboard
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_0_Data_SHADE], 3h
	mov		[Port_0_DriveMode_0_SHADE], 3h
	mov		[Port_0_DriveMode_1_SHADE], ffh
	mov		[Port_2_Data_SHADE], 0h
	mov		[Port_2_DriveMode_0_SHADE], 7fh
	mov		[Port_2_DriveMode_1_SHADE], 80h

	lcall	LoadConfig_evalboard
	lcall	LoadConfigTBL_evalboard_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration evalboard
;
;    Load configuration registers for evalboard.
...
;               CUR_PP
;
_LoadConfig_evalboard:
 LoadConfig_evalboard:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_evalboard_Bank0
    mov     X, <LoadConfigTBL_evalboard_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_evalboard_Bank1
    mov     X, <LoadConfigTBL_evalboard_Bank1
