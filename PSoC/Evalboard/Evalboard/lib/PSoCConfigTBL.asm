...
export LoadConfigTBL_evalboard_Bank1
export LoadConfigTBL_evalboard_Bank0
export LoadConfigTBL_evalboard_Ordered
AREA lit(rom, rel)
LoadConfigTBL_evalboard_Bank0:
...
;       Instance name Timer16, Block Name TIMER16_MSB(DBB01)
	...
	db		25h, 00h		;Timer16_PERIOD_MSB_REG(DBB01DR1)
...
LoadConfigTBL_evalboard_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 03h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
