...
export LoadConfig_psoc_slave
export _LoadConfig_psoc_slave
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_psoc_slave
	lcall	LoadConfigTBL_psoc_slave_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration psoc_slave
;
;    Load configuration registers for psoc_slave.
...
;               CUR_PP
;
_LoadConfig_psoc_slave:
 LoadConfig_psoc_slave:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_psoc_slave_Bank0
    mov     X, <LoadConfigTBL_psoc_slave_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_psoc_slave_Bank1
    mov     X, <LoadConfigTBL_psoc_slave_Bank1
