...
export LoadConfigTBL_Accelerometer_Bank1
export LoadConfigTBL_Accelerometer_Bank0
export LoadConfigTBL_Accelerometer_Ordered
AREA lit(rom, rel)
LoadConfigTBL_Accelerometer_Bank0:
...
;       Instance name DUALADC, Block Name CNT2(DCB03)
	db		2fh, 00h		;DUALADC_bCounter2_CR0(DCB03CR0)
	db		2dh, 00h		;DUALADC_bPeriod2(DCB03DR1)
	db		2eh, 00h		;DUALADC_bCompare2(DCB03DR2)
;       Instance name DUALADC, Block Name PWM16_LSB(DBB01)
	db		27h, 00h		;DUALADC_fPWM_LSB_CR0(DBB01CR0)
	db		25h, 00h		;DUALADC_bPWM_Period_LSB(DBB01DR1)
	db		26h, 00h		;DUALADC_bPWM_IntTime_LSB(DBB01DR2)
;       Instance name DUALADC, Block Name PWM16_MSB(DCB02)
	db		2bh, 00h		;DUALADC_fPWM_MSB_CR0(DCB02CR0)
	db		29h, 00h		;DUALADC_bPWM_Period_MSB(DCB02DR1)
	db		2ah, 00h		;DUALADC_bPWM_IntTime_MSB(DCB02DR2)
;  Instance name LCD, User Module LCD
;  Instance name PGA_X_Achse, User Module PGA
;       Instance name PGA_X_Achse, Block Name GAIN(ACB01)
	db		75h, feh		;PGA_X_Achse_GAIN_CR0(ACB01CR0)
	db		76h, 21h		;PGA_X_Achse_GAIN_CR1(ACB01CR1)
	db		77h, 20h		;PGA_X_Achse_GAIN_CR2(ACB01CR2)
	db		74h, 00h		;PGA_X_Achse_GAIN_CR3(ACB01CR3)
;  Instance name PGA_Y_Achse, User Module PGA
;       Instance name PGA_Y_Achse, Block Name GAIN(ACB00)
	db		71h, feh		;PGA_Y_Achse_GAIN_CR0(ACB00CR0)
	db		72h, 21h		;PGA_Y_Achse_GAIN_CR1(ACB00CR1)
	db		73h, 20h		;PGA_Y_Achse_GAIN_CR2(ACB00CR2)
	db		70h, 00h		;PGA_Y_Achse_GAIN_CR3(ACB00CR3)
;  Global Register values Bank 0
	db		60h, 25h		; AnalogColumnInputSelect register (AMX_IN)
	...
	db		ffh
LoadConfigTBL_Accelerometer_Bank1:
;  Instance name DUALADC, User Module DUALADC
;       Instance name DUALADC, Block Name ADC1(ASC10)
;       Instance name DUALADC, Block Name ADC2(ASD11)
;       Instance name DUALADC, Block Name CNT1(DBB00)
...
;       Instance name DUALADC, Block Name CNT2(DCB03)
	db		2ch, 21h		;DUALADC_fCounter2FN(DCB03FN)
	db		2dh, 55h		;DUALADC_fCounter2SL(DCB03IN)
	db		2eh, 40h		;DUALADC_fCounter2OS(DCB03OU)
;       Instance name DUALADC, Block Name PWM16_LSB(DBB01)
	db		24h, 01h		;DUALADC_bfPWM_LSB_FN(DBB01FN)
	db		25h, 15h		;DUALADC_(DBB01IN)
	db		26h, 40h		;DUALADC_(DBB01OU)
;       Instance name DUALADC, Block Name PWM16_MSB(DCB02)
	db		28h, 21h		;DUALADC_bfPWM_MSB_FN(DCB02FN)
	db		29h, 35h		;DUALADC_(DCB02IN)
	db		2ah, 40h		;DUALADC_(DCB02OU)
;  Instance name LCD, User Module LCD
;  Instance name PGA_X_Achse, User Module PGA
;       Instance name PGA_X_Achse, Block Name GAIN(ACB01)
;  Instance name PGA_Y_Achse, User Module PGA
...
LoadConfigTBL_Accelerometer_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[10h], 7fh		; Port_4_DriveMode_0 register (PRT4DM0)
	mov	reg[11h], 80h		; Port_4_DriveMode_1 register (PRT4DM1)
	M8C_SetBank0
	mov	reg[13h], 80h		; Port_4_DriveMode_2 register (PRT4DM2)
