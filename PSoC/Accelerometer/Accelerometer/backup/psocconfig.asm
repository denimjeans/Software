...
export LoadConfig_Accelerometer
export _LoadConfig_Accelerometer
export Port_4_Data_SHADE
export _Port_4_Data_SHADE
export Port_4_DriveMode_0_SHADE
export _Port_4_DriveMode_0_SHADE
export Port_4_DriveMode_1_SHADE
export _Port_4_DriveMode_1_SHADE
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_4_DriveMode_0_SHADE], 7fh
	mov		[Port_4_DriveMode_1_SHADE], 80h

	lcall	LoadConfig_Accelerometer
	lcall	LoadConfigTBL_Accelerometer_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration Accelerometer
;
;    Load configuration registers for Accelerometer.
...
;               CUR_PP
;
_LoadConfig_Accelerometer:
 LoadConfig_Accelerometer:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_Accelerometer_Bank0
    mov     X, <LoadConfigTBL_Accelerometer_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_Accelerometer_Bank1
    mov     X, <LoadConfigTBL_Accelerometer_Bank1
...
_Port_4_DriveMode_0_SHADE:
Port_4_DriveMode_0_SHADE:	BLK	1
_Port_4_DriveMode_1_SHADE:
Port_4_DriveMode_1_SHADE:	BLK	1
