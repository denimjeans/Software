...
export LoadConfig_chronograph
export _LoadConfig_chronograph
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_0_DriveMode_0_SHADE], 7fh
	mov		[Port_0_DriveMode_1_SHADE], 80h

	lcall	LoadConfig_chronograph
	lcall	LoadConfigTBL_chronograph_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration chronograph
;
;    Load configuration registers for chronograph.
...
;               CUR_PP
;
_LoadConfig_chronograph:
 LoadConfig_chronograph:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_chronograph_Bank0
    mov     X, <LoadConfigTBL_chronograph_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_chronograph_Bank1
    mov     X, <LoadConfigTBL_chronograph_Bank1
