...
LCD_Port:           equ    PRT0DR
LCD_PortMode0:      equ    PRT0DM0
LCD_PortMode1:      equ    PRT0DM1
...
;
 LCD_WCNTL_Nibble:
    ...
    push  A
    RAM_SETPAGE_CUR >Port_0_Data_SHADE           ; Set CUR_PP to LCD variable address
    and   [Port_0_Data_SHADE],~LCD_PORT_MASK
    ...
    or    A,[Port_0_Data_SHADE]                  ; OR in bit 7 just
    mov   reg[LCD_Port], A                       ; Write data
    mov   [Port_0_Data_SHADE],A                  ; Keep shadow register in sync
    nop
...
LCD_WDATA_Nibble:
    ...
    RAM_SETPAGE_CUR >Port_0_Data_SHADE          ; Set CUR_PP to LCD variable address
    and   [Port_0_Data_SHADE],~LCD_PORT_MASK
    or    [Port_0_Data_SHADE],LCD_RS                  ; Raise RS to signify a Data Write
    mov   A,[Port_0_Data_SHADE]
    mov   reg[LCD_Port],A
    ...
    or    A,[Port_0_Data_SHADE]                       ; Keep shadow in sync
    mov   reg[LCD_Port], A                            ; Write data
    mov   [Port_0_Data_SHADE],A                       ; Keep shadow in sync
    NOP
...
LCD_Check_Ready:
    ...
    RAM_SETPAGE_CUR >Port_0_Data_SHADE                ; Set CUR_PP to LCD variable address
    and   [Port_0_Data_SHADE],~LCD_PORT_MASK          ; Mask of all LCD bits
    mov   A,[Port_0_Data_SHADE]
    mov   reg[LCD_Port],A                             ; Zero LCD port bits

    and   [Port_0_DriveMode_0_SHADE],~LCD_DATA_MASK   ; Clear out LCD mode bits.
    ...
    or    [Port_0_Data_SHADE],LCD_RW                  ; Raise RW to signify Read operation
    mov   A,[Port_0_Data_SHADE]
    mov   reg[LCD_Port],A
    NOP
...
.LCD_RDY_LOOP:
    or    [Port_0_Data_SHADE], LCD_CNTL_READ                    ; Raise E to start cycle
    mov   A,[Port_0_Data_SHADE]
    mov   reg[LCD_Port],A
...
ENDIF   
    ...
    push  A
    and   [Port_0_Data_SHADE],(~LCD_PORT_MASK | LCD_RW)         ; Lower E signal
    mov   A,[Port_0_Data_SHADE]
    mov   reg[LCD_Port],A
...
.UNLOCK:
    ...
    or    [Port_0_DriveMode_0_SHADE],LCD_PORT_WRITE   ; Revert Data bit to Write mode
    mov   A,[Port_0_DriveMode_0_SHADE]
    M8C_SetBank1
...
_LCD_Init:
    ...
    and   [Port_0_DriveMode_0_SHADE],~LCD_PORT_MASK             ; Mask off LCD bits
    or    [Port_0_DriveMode_0_SHADE],LCD_PORT_WRITE             ; Set LCD port for writing
    and   [Port_0_DriveMode_1_SHADE],~LCD_PORT_MASK             ; Mask off LCD bits
