...
export LoadConfig_i2c_master
export _LoadConfig_i2c_master
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_i2c_master
	lcall	LoadConfigTBL_i2c_master_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration i2c_master
;
;    Load configuration registers for i2c_master.
...
;               CUR_PP
;
_LoadConfig_i2c_master:
 LoadConfig_i2c_master:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_i2c_master_Bank0
    mov     X, <LoadConfigTBL_i2c_master_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_i2c_master_Bank1
    mov     X, <LoadConfigTBL_i2c_master_Bank1
