...
export LoadConfigTBL_i2c_master_Bank1
export LoadConfigTBL_i2c_master_Bank0
...
;  Global Register values Bank 0
	...
	db		b2h, 01h		; Row_0_LogicInputAMux register (RDI0IS)
...
LoadConfigTBL_i2c_master_Ordered:
