#line 18 "G:\Cypress\PSOCDE~1\5.2\Common\CY110F~1\tools\include\CY8C27~1\m8c.h"
...
#line 6 "H:\Hobby\PROGRA~1\PSOCPR~1\I2C_MA~1\I2C_MA~1\lib\PSoCGPIOINT.h"
...
extern BYTE Port_4_DriveMode_1_SHADE;
#line 27 "H:\Hobby\PROGRA~1\PSOCPR~1\I2C_MA~1\I2C_MA~1\lib\I2CHWMstr.h"
...
#line 21 "H:\Hobby\PROGRA~1\PSOCPR~1\I2C_MA~1\I2C_MA~1\lib\I2CHWCommon.h"
...
#pragma ioport I2CHW_DR: 0x0d8 
BYTE I2CHW_DR;

#pragma ioport I2CHW_MSCR: 0x0d9 
BYTE I2CHW_MSCR;
...
extern void I2CHW_Start(void); 
extern void I2CHW_DisableInt(void); 
extern void I2CHW_ResumeInt(void); 
extern void I2CHW_EnableInt(void); 
extern void I2CHW_ClearInt(void); 
extern void I2CHW_Stop(void); 





extern void I2CHW_EnableMstr(void); 
extern void I2CHW_DisableMstr(void); 

extern void I2CHW_InitWrite(BYTE * pI2CHW_WriteBuf, BYTE I2CHW_Write_Count); 
extern void I2CHW_InitRamRead(BYTE * pI2CHW_ReadBuf, BYTE I2CHW_Read_Count); 
extern void I2CHW_InitFlashRead(const BYTE * pI2CHW_flashaddr, unsigned int I2CHW_Read_CountHI); 
extern BYTE I2CHW_bReadI2CStatus(void); 
extern void I2CHW_ClrRdStatus(void); 
extern void I2CHW_ClrWrStatus(void); 


#line 20 "H:\Hobby\PROGRA~1\PSOCPR~1\I2C_MA~1\I2C_MA~1\lib\LCD.h"
...
#line 17 "H:\Hobby\PROGRA~1\PSOCPR~1\I2C_MA~1\I2C_MA~1\lib\Timer16.h"
...
#pragma fastcall16 Timer16_wReadTimer 
#pragma fastcall16 Timer16_wReadTimerSaveCV 
#pragma fastcall16 Timer16_WritePeriod 
#pragma fastcall16 Timer16_wReadCompareValue 
#pragma fastcall16 Timer16_WriteCompareValue 




#pragma fastcall16 wTimer16_ReadCounter 
#pragma fastcall16 wTimer16_CaptureCounter 
#pragma fastcall16 wTimer16_ReadTimer 
#pragma fastcall16 wTimer16_ReadTimerSaveCV 
#pragma fastcall16 wTimer16_ReadCompareValue 
...
extern WORD Timer16_wReadTimer(void); 
extern WORD Timer16_wReadTimerSaveCV(void); 
extern void Timer16_WritePeriod(WORD wPeriod); 
extern WORD Timer16_wReadCompareValue(void); 
extern void Timer16_WriteCompareValue(WORD wCompareValue); 




extern WORD wTimer16_ReadCompareValue(void); 
extern WORD wTimer16_ReadTimerSaveCV(void); 
extern WORD wTimer16_ReadCounter(void); 
extern WORD wTimer16_ReadTimer(void); 
extern WORD wTimer16_CaptureCounter(void); 
...
#pragma ioport Timer16_COUNTER_LSB_REG: 0x020 
BYTE Timer16_COUNTER_LSB_REG;
#pragma ioport Timer16_COUNTER_MSB_REG: 0x024 
BYTE Timer16_COUNTER_MSB_REG;
#pragma ioport Timer16_PERIOD_LSB_REG: 0x021 
BYTE Timer16_PERIOD_LSB_REG;
#pragma ioport Timer16_PERIOD_MSB_REG: 0x025 
BYTE Timer16_PERIOD_MSB_REG;
#pragma ioport Timer16_COMPARE_LSB_REG: 0x022 
BYTE Timer16_COMPARE_LSB_REG;
#pragma ioport Timer16_COMPARE_MSB_REG: 0x026 
BYTE Timer16_COMPARE_MSB_REG;
#pragma ioport Timer16_CONTROL_LSB_REG: 0x023 
BYTE Timer16_CONTROL_LSB_REG;
#pragma ioport Timer16_CONTROL_MSB_REG: 0x027 
BYTE Timer16_CONTROL_MSB_REG;
#pragma ioport Timer16_FUNC_LSB_REG: 0x120 
BYTE Timer16_FUNC_LSB_REG;
#pragma ioport Timer16_FUNC_MSB_REG: 0x124 
BYTE Timer16_FUNC_MSB_REG;
#pragma ioport Timer16_INPUT_LSB_REG: 0x121 
BYTE Timer16_INPUT_LSB_REG;
#pragma ioport Timer16_INPUT_MSB_REG: 0x125 
BYTE Timer16_INPUT_MSB_REG;
#pragma ioport Timer16_OUTPUT_LSB_REG: 0x122 
BYTE Timer16_OUTPUT_LSB_REG;
#pragma ioport Timer16_OUTPUT_MSB_REG: 0x126 
BYTE Timer16_OUTPUT_MSB_REG;
#pragma ioport Timer16_INT_REG: 0x0e1 
BYTE Timer16_INT_REG;


#line 7 "H:\Hobby\PROGRA~1\PSOCPR~1\I2C_MA~1\I2C_MA~1\main.c"
...
void Read_PSoCSlave(char *Button)
{
 I2CHW_fReadBytes(0x40, Button, 1, 0x00); 
 while(!(I2CHW_bReadI2CStatus() & 0x04)); 
 I2CHW_ClrRdStatus();
