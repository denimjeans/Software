...
export LoadConfig_spi
export _LoadConfig_spi
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_spi
	lcall	LoadConfigTBL_spi_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration spi
;
;    Load configuration registers for spi.
...
_LoadConfig_spi:
 LoadConfig_spi:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_spi_Bank0
    mov     X, <LoadConfigTBL_spi_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_spi_Bank1
    mov     X, <LoadConfigTBL_spi_Bank1
