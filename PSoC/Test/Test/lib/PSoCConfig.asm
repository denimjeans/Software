...
export LoadConfig_test
export _LoadConfig_test
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_test
	lcall	LoadConfigTBL_test_Ordered
...
;
;    Load configuration registers for test.
...
_LoadConfig_test:
 LoadConfig_test:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_test_Bank0
    mov     X, <LoadConfigTBL_test_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_test_Bank1
    mov     X, <LoadConfigTBL_test_Bank1
