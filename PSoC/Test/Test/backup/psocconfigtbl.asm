...
export LoadConfigTBL_test_Bank1
export LoadConfigTBL_test_Bank0
export LoadConfigTBL_test_Ordered
AREA lit(rom, rel)
LoadConfigTBL_test_Bank0:
...
;       Instance name PWM16, Block Name PWM16_LSB(DBB00)
	...
	db		22h, ffh		;PWM16_COMPARE_LSB_REG(DBB00DR2)
;       Instance name PWM16, Block Name PWM16_MSB(DBB01)
	db		27h, 00h		;PWM16_CONTROL_MSB_REG(DBB01CR0)
	db		25h, 80h		;PWM16_PERIOD_MSB_REG(DBB01DR1)
	db		26h, 3fh		;PWM16_COMPARE_MSB_REG(DBB01DR2)
