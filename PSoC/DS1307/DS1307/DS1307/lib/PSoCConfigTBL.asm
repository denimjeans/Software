...
export LoadConfigTBL_DS1307_Bank1
export LoadConfigTBL_DS1307_Bank0
export LoadConfigTBL_DS1307_Ordered
AREA lit(rom, rel)
LoadConfigTBL_DS1307_Bank0:
...
;  Global Register values Bank 1
	...
	db		e1h, 10h		; OscillatorControl_1 register (OSC_CR1)
	db		e2h, 00h		; OscillatorControl_2 register (OSC_CR2)
	db		dfh, efh		; OscillatorControl_3 register (OSC_CR3)
...
;  Ordered Global Register values
	...
	mov	reg[04h], e0h		; Port_1_Data register (PRT1DR)
	M8C_SetBank1
	mov	reg[04h], e0h		; Port_1_DriveMode_0 register (PRT1DM0)
	...
	M8C_SetBank1
	mov	reg[06h], 40h		; Port_1_IntCtrl_0 register (PRT1IC0)
	mov	reg[07h], 00h		; Port_1_IntCtrl_1 register (PRT1IC1)
	M8C_SetBank0
	mov	reg[05h], 40h		; Port_1_IntEn register (PRT1IE)
