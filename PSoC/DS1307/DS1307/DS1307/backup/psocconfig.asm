...
export LoadConfig_DS1307
export _LoadConfig_DS1307
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_DS1307
	lcall	LoadConfigTBL_DS1307_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration DS1307
;
;    Load configuration registers for DS1307.
...
_LoadConfig_DS1307:
 LoadConfig_DS1307:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_DS1307_Bank0
    mov     X, <LoadConfigTBL_DS1307_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_DS1307_Bank1
    mov     X, <LoadConfigTBL_DS1307_Bank1
