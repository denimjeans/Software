...
export LoadConfigTBL_psoc_master_Bank1
export LoadConfigTBL_psoc_master_Bank0
export LoadConfigTBL_psoc_master_Ordered
AREA lit(rom, rel)
LoadConfigTBL_psoc_master_Bank0:
...
;       Instance name Timer16, Block Name TIMER16_LSB(DBB00)
	...
	db		21h, 00h		;Timer16_PERIOD_LSB_REG(DBB00DR1)
...
;       Instance name Timer16, Block Name TIMER16_MSB(DBB01)
	...
	db		25h, 80h		;Timer16_PERIOD_MSB_REG(DBB01DR1)
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_psoc_master_Bank1:
;  Instance name LCD, User Module LCD
;  Instance name Timer16, User Module Timer16
;       Instance name Timer16, Block Name TIMER16_LSB(DBB00)
...
LoadConfigTBL_psoc_master_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[07h], bch		; Port_1_DriveMode_2 register (PRT1DM2)
