...
export LoadConfig_psoc_master
export _LoadConfig_psoc_master
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_psoc_master
	lcall	LoadConfigTBL_psoc_master_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration psoc_master
;
;    Load configuration registers for psoc_master.
...
;               CUR_PP
;
_LoadConfig_psoc_master:
 LoadConfig_psoc_master:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_psoc_master_Bank0
    mov     X, <LoadConfigTBL_psoc_master_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_psoc_master_Bank1
    mov     X, <LoadConfigTBL_psoc_master_Bank1
