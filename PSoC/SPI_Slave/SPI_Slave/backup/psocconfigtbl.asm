...
export LoadConfigTBL_spi_slave_Bank1
export LoadConfigTBL_spi_slave_Bank0
export LoadConfigTBL_spi_slave_Ordered
AREA lit(rom, rel)
LoadConfigTBL_spi_slave_Bank0:
...
;  Instance name LED7SEG, User Module LED7SEG
;       Instance name LED7SEG, Block Name MPXTMR(DBB01)
	db		27h, 04h		;LED7SEG_CONTROL_REG(DBB01CR0)
	db		25h, 1fh		;LED7SEG_(DBB01DR1)
	db		26h, 0fh		;LED7SEG_(DBB01DR2)
...
;       Instance name SPIS, Block Name SPIS(DCB02)
	db		2bh, 00h		;SPIS_CONTROL_REG  (DCB02CR0)
	db		29h, 00h		;SPIS_TX_BUFFER_REG(DCB02DR1)
	db		2ah, 00h		;SPIS_RX_BUFFER_REG(DCB02DR2)
;  Instance name Timer16, User Module Timer16
;       Instance name Timer16, Block Name TIMER16_LSB(DCB03)
	db		2fh, 00h		;Timer16_CONTROL_LSB_REG(DCB03CR0)
	db		2dh, ffh		;Timer16_PERIOD_LSB_REG(DCB03DR1)
	db		2eh, 00h		;Timer16_COMPARE_LSB_REG(DCB03DR2)
;       Instance name Timer16, Block Name TIMER16_MSB(DBB10)
	db		33h, 04h		;Timer16_CONTROL_MSB_REG(DBB10CR0)
	db		31h, 7fh		;Timer16_PERIOD_MSB_REG(DBB10DR1)
	db		32h, 00h		;Timer16_COMPARE_MSB_REG(DBB10DR2)
...
;  Instance name LED7SEG, User Module LED7SEG
;       Instance name LED7SEG, Block Name MPXTMR(DBB01)
	db		24h, 20h		;LED7SEG_(DBB01FN)
	db		25h, 17h		;LED7SEG_(DBB01IN)
	db		26h, 40h		;LED7SEG_(DBB01OU)
;  Instance name PGA, User Module PGA
;       Instance name PGA, Block Name GAIN(ACB00)
;  Instance name SPIS, User Module SPIS
;       Instance name SPIS, Block Name SPIS(DCB02)
	db		28h, 0eh		;SPIS_FUNCTION_REG (DCB02FN)
	db		29h, dfh		;SPIS_INPUT_REG    (DCB02IN)
	db		2ah, 64h		;SPIS_OUTPUT_REG   (DCB02OU)
;  Instance name Timer16, User Module Timer16
;       Instance name Timer16, Block Name TIMER16_LSB(DCB03)
	db		2ch, 00h		;Timer16_FUNC_LSB_REG(DCB03FN)
	db		2dh, 17h		;Timer16_INPUT_LSB_REG(DCB03IN)
	db		2eh, 40h		;Timer16_OUTPUT_LSB_REG(DCB03OU)
;       Instance name Timer16, Block Name TIMER16_MSB(DBB10)
	db		30h, 20h		;Timer16_FUNC_MSB_REG(DBB10FN)
	db		31h, 37h		;Timer16_INPUT_MSB_REG(DBB10IN)
	db		32h, 40h		;Timer16_OUTPUT_MSB_REG(DBB10OU)
...
LoadConfigTBL_spi_slave_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[03h], c6h		; Port_0_DriveMode_2 register (PRT0DM2)
	mov	reg[02h], 39h		; Port_0_GlobalSelect register (PRT0GS)
	M8C_SetBank1
	...
	M8C_SetBank1
	mov	reg[0ch], ffh		; Port_3_DriveMode_0 register (PRT3DM0)
	...
	M8C_SetBank1
	mov	reg[10h], 0fh		; Port_4_DriveMode_0 register (PRT4DM0)
	mov	reg[11h], f0h		; Port_4_DriveMode_1 register (PRT4DM1)
	M8C_SetBank0
	mov	reg[13h], f0h		; Port_4_DriveMode_2 register (PRT4DM2)
