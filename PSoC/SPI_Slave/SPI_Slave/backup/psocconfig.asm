...
export LoadConfig_spi_slave
export _LoadConfig_spi_slave
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_spi_slave
	lcall	LoadConfigTBL_spi_slave_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration spi_slave
;
;    Load configuration registers for spi_slave.
...
;               CUR_PP
;
_LoadConfig_spi_slave:
 LoadConfig_spi_slave:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_spi_slave_Bank0
    mov     X, <LoadConfigTBL_spi_slave_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_spi_slave_Bank1
    mov     X, <LoadConfigTBL_spi_slave_Bank1
