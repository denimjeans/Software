...
export LoadConfig_lcd
export _LoadConfig_lcd
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_lcd
	lcall	LoadConfigTBL_lcd_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration lcd
;
;    Load configuration registers for lcd.
...
_LoadConfig_lcd:
 LoadConfig_lcd:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_lcd_Bank0
    mov     X, <LoadConfigTBL_lcd_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_lcd_Bank1
    mov     X, <LoadConfigTBL_lcd_Bank1
