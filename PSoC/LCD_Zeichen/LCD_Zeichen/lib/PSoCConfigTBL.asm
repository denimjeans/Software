...
export LoadConfigTBL_LCD_Zeichen_Bank1
export LoadConfigTBL_LCD_Zeichen_Bank0
export LoadConfigTBL_LCD_Zeichen_Ordered
AREA lit(rom, rel)
LoadConfigTBL_LCD_Zeichen_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_LCD_Zeichen_Bank1:
;  Instance name LCD_1, User Module LCD
...
LoadConfigTBL_LCD_Zeichen_Ordered:
