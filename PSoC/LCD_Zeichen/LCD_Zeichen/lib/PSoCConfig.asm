...
export LoadConfig_LCD_Zeichen
export _LoadConfig_LCD_Zeichen
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_LCD_Zeichen
	lcall	LoadConfigTBL_LCD_Zeichen_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration LCD_Zeichen
;
;    Load configuration registers for LCD_Zeichen.
...
;               CUR_PP
;
_LoadConfig_LCD_Zeichen:
 LoadConfig_LCD_Zeichen:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_LCD_Zeichen_Bank0
    mov     X, <LoadConfigTBL_LCD_Zeichen_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_LCD_Zeichen_Bank1
    mov     X, <LoadConfigTBL_LCD_Zeichen_Bank1
