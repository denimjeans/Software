...
export LoadConfig_hp03s
export _LoadConfig_hp03s
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_hp03s
	lcall	LoadConfigTBL_hp03s_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration hp03s
;
;    Load configuration registers for hp03s.
...
_LoadConfig_hp03s:
 LoadConfig_hp03s:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_hp03s_Bank0
    mov     X, <LoadConfigTBL_hp03s_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_hp03s_Bank1
    mov     X, <LoadConfigTBL_hp03s_Bank1
