...
export LoadConfig_funk_lampe
export _LoadConfig_funk_lampe
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_funk_lampe
	lcall	LoadConfigTBL_funk_lampe_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration funk_lampe
;
;    Load configuration registers for funk_lampe.
...
;               CUR_PP
;
_LoadConfig_funk_lampe:
 LoadConfig_funk_lampe:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_funk_lampe_Bank0
    mov     X, <LoadConfigTBL_funk_lampe_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_funk_lampe_Bank1
    mov     X, <LoadConfigTBL_funk_lampe_Bank1
