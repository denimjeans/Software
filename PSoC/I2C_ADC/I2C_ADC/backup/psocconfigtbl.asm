...
export LoadConfigTBL_i2c_slave_Bank1
export LoadConfigTBL_i2c_slave_Bank0
export LoadConfigTBL_i2c_slave_Ordered
AREA lit(rom, rel)
LoadConfigTBL_i2c_slave_Bank0:
...
LoadConfigTBL_i2c_slave_Ordered:
