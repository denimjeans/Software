...
export LoadConfig_I2C
export _LoadConfig_I2C
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_I2C
	lcall	LoadConfigTBL_I2C_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration I2C
;
;    Load configuration registers for I2C.
...
_LoadConfig_I2C:
 LoadConfig_I2C:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_I2C_Bank0
    mov     X, <LoadConfigTBL_I2C_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_I2C_Bank1
    mov     X, <LoadConfigTBL_I2C_Bank1
