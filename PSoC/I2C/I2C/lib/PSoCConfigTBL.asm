...
export LoadConfigTBL_I2C_Bank1
export LoadConfigTBL_I2C_Bank0
export LoadConfigTBL_I2C_Ordered
AREA lit(rom, rel)
LoadConfigTBL_I2C_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_I2C_Bank1:
;  Instance name I2CHW, User Module I2CHW
;  Instance name LCD, User Module LCD
;  Instance name SPIM, User Module SPIM
;       Instance name SPIM, Block Name SPIM(DCB02)
	db		28h, 06h		;SPIM_FUNCTION_REG (DCB02FN)
	db		29h, 86h		;SPIM_INPUT_REG    (DCB02IN)
	db		2ah, 75h		;SPIM_OUTPUT_REG   (DCB02OU)
;  Instance name Timer16, User Module Timer16
;       Instance name Timer16, Block Name TIMER16_LSB(DBB00)
...
LoadConfigTBL_I2C_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 00h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], 07h		; Port_0_DriveMode_0 register (PRT0DM0)
