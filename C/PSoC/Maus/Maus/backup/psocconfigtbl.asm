...
export LoadConfigTBL_maus_Bank1
export LoadConfigTBL_maus_Bank0
export LoadConfigTBL_maus_Ordered
AREA lit(rom, rel)
LoadConfigTBL_maus_Bank0:
...
;  Global Register values Bank 0
	db		60h, 08h		; AnalogColumnInputSelect register (AMX_IN)
	...
	db		ffh
LoadConfigTBL_maus_Bank1:
;  Instance name Timer16, User Module Timer16
;       Instance name Timer16, Block Name TIMER16_LSB(DBB00)
	db		20h, 00h		;Timer16_FUNC_LSB_REG(DBB00FN)
	db		21h, 07h		;Timer16_INPUT_LSB_REG(DBB00IN)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[08h], 2fh		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], d0h		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], d0h		; Port_2_DriveMode_2 register (PRT2DM2)
	...
	mov	reg[0dh], bfh		; Port_3_DriveMode_1 register (PRT3DM1)
	M8C_SetBank0
	mov	reg[0fh], bfh		; Port_3_DriveMode_2 register (PRT3DM2)
