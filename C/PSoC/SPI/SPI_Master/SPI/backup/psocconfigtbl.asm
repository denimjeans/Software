...
export LoadConfigTBL_spi_Bank1
export LoadConfigTBL_spi_Bank0
export LoadConfigTBL_spi_Ordered
AREA lit(rom, rel)
LoadConfigTBL_spi_Bank0:
...
;  Global Register values Bank 0
	...
	db		b0h, 02h		; Row_0_InputMux register (RDI0RI)
	...
	db		b6h, 40h		; Row_0_OutputDrive_1 register (RDI0SRO1)
...
;       Instance name SPIM, Block Name SPIM(DCB02)
	...
	db		29h, c7h		;SPIM_INPUT_REG    (DCB02IN)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[08h], 03h		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], fch		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], fch		; Port_2_DriveMode_2 register (PRT2DM2)
	...
	M8C_SetBank1
	mov	reg[0ch], 28h		; Port_3_DriveMode_0 register (PRT3DM0)
	mov	reg[0dh], 57h		; Port_3_DriveMode_1 register (PRT3DM1)
	M8C_SetBank0
	mov	reg[0fh], 56h		; Port_3_DriveMode_2 register (PRT3DM2)
	mov	reg[0eh], 29h		; Port_3_GlobalSelect register (PRT3GS)
	M8C_SetBank1
