...
;  Global Symbols
;-----------------------------------------------
export  PGA_X_Achse_Start
export _PGA_X_Achse_Start
export  PGA_X_Achse_SetPower
export _PGA_X_Achse_SetPower

export  PGA_X_Achse_SetGain
export _PGA_X_Achse_SetGain

export  PGA_X_Achse_Stop
export _PGA_X_Achse_Stop

IF (PGA_X_Achse_AGNDBUFAPI)
export  PGA_X_Achse_EnableAGNDBuffer
export _PGA_X_Achse_EnableAGNDBuffer
export  PGA_X_Achse_DisableAGNDBuffer
export _PGA_X_Achse_DisableAGNDBuffer
ENDIF
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PGA_X_Achse_Start
;  FUNCTION NAME: PGA_X_Achse_SetPower
;
;  DESCRIPTION:
...
;
 PGA_X_Achse_Start:
_PGA_X_Achse_Start:
 PGA_X_Achse_SetPower:
_PGA_X_Achse_SetPower:
...
;
   ...
   mov  A, reg[PGA_X_Achse_GAIN_CR2]                       ; read power value
   and  A, ~POWERMASK                                ; clear power bits in A
   or   A, [X]                                       ; combine power value with balance of reg.
   mov  reg[PGA_X_Achse_GAIN_CR2], A                  ; move complete value back to register
   pop  A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PGA_X_Achse_SetGain
;
;  DESCRIPTION:
...
;
   ...
   mov  A, reg[PGA_X_Achse_GAIN_CR0]                       ; read mux settings
   and  A, ~GAINREGMASK                                   ; clear gain bits in A
   tst  [X],HIGHGAIN                                      ; See if High Gain is set
   jnz  .SETHIGHGAIN
   and  reg[PGA_X_Achse_GAIN_CR3],~EXGAIN                  ; Clear High Gain bit.
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[PGA_X_Achse_GAIN_CR0], A                       ; move complete value back to register
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
...
.SETHIGHGAIN:
   ...
   or   A, [X]                                            ; combine gain value with balance of reg.
   mov  reg[PGA_X_Achse_GAIN_CR0], A                       ; move complete value back to register
   or   reg[PGA_X_Achse_GAIN_CR3], EXGAIN                  ; Set High Gain bit.
   pop  A
   RAM_EPILOGUE RAM_USE_CLASS_2
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PGA_X_Achse_Stop
;
;  DESCRIPTION:
...
_PGA_X_Achse_Stop:
   ...
   and REG[PGA_X_Achse_GAIN_CR2], ~POWERMASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PGA_X_Achse_EnableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 PGA_X_Achse_EnableAGNDBuffer:
_PGA_X_Achse_EnableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   reg[PGA_X_Achse_GAIN_CR3], ~AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PGA_X_Achse_DisableAGNDBuffer
;
;  DESCRIPTION:
...
;    functions.
;
 PGA_X_Achse_DisableAGNDBuffer:
_PGA_X_Achse_DisableAGNDBuffer:
   RAM_PROLOGUE RAM_USE_CLASS_1
   or    reg[PGA_X_Achse_GAIN_CR3], AGNDBUFMASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
ENDIF

; End of File PGA_X_Achse.asm
